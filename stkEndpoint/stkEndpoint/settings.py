"""
Django settings for stkEndpoint project.
...
SECRET_KEY = 'django-insecure-(cg5g5-86eue5^1js!ma7o0m@4^oc5($em$%91v8fvg_7wnt^e'
...
WSGI_APPLICATION = 'stkEndpoint.wsgi.application'
